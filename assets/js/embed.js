window.tf = function() {
    ...
    var e = {
            6664: function(e, t, n) {
                ...
                }), document.addEventListener("DOMContentLoaded", s, !1), "interactive" !== document.readyState && "complete" !== document.readyState || s()
            },
            8027: function(e, t) {
                Object.defineProperty(t, "__esModule", {
                    value: !0
            ...
            7528: function(e, t, n) {
                ...
                var r = n(6797),
                    ...
                    c = function(e, t) {
                        void 0 === e && (e = "div"), void 0 === t && (t = "typeform-popover-button-icon");
                ...
                t.createPopover = function(e, t) {
                    void 0 === t && (t = {});
                    var n, s, l, f, p, v, m = o(o({}, d), t),
                        b = r.createIframe(e, "popover", m),
                        y = b.iframe,
                        h = b.embedId,
                        g = function(e, t) {
                            var n = document.createElement("div");
                            return n.className = "typeform-popover", n.dataset.testid = "typeform-popover", r.setElementSize(n, {
                                width: e,
                                height: t
                            })
                        }(m.width, m.height),
                        _ = function() {
                            ...
                            return e.className = "typeform-popover-wrapper", e.dataset.testid = "typeform-popover-wrapper", e
                        }(),
                        O = (n = m.customIcon, s = m.buttonColor || d.buttonColor, l = r.getTextColor(s), (f = document.createElement("div")).className = "typeform-popover-button-icon", f.innerHTML = n ? "<img alt='popover trigger icon button' src='" + n + "'/>" : '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"\n    xmlns="http://www.w3.org/2000/svg">\n      <path d="M21 0H0V9L10.5743 24V16.5H21C22.6567 16.5 24 15.1567 24 13.5V3C24 1.34325 22.6567 0 21 0ZM7.5\n    9.75C6.672 9.75 6 9.07875 6 8.25C6 7.42125 6.672 6.75 7.5 6.75C8.328 6.75 9 7.42125 9 8.25C9 9.07875 8.328 9.75\n    7.5 9.75ZM12.75 9.75C11.922 9.75 11.25 9.07875 11.25 8.25C11.25 7.42125 11.922 6.75 12.75 6.75C13.578 6.75 14.25\n    7.42125 14.25 8.25C14.25 9.07875 13.578 9.75 12.75 9.75ZM18 9.75C17.172 9.75 16.5 9.07875 16.5 8.25C16.5 7.42125\n    17.172 6.75 18 6.75C18.828 6.75 19.5 7.42125 19.5 8.25C19.5 9.07875 18.828 9.75 18 9.75Z" fill="' + l + '"></path>\n    </svg>', f.dataset.testid = "default-icon", f),
                        w = function() {
                            var e = document.createElement("div");
                            e.className = "typeform-spinner";
                            var t = document.createElement("div");
                            return t.className = "typeform-popover-button-icon", t.dataset.testid = "spinner-icon", t.append(e), t
                        }(),
                        P = c(),
                        ...
                        j = function(e) {
                            ...
                            return n.className = "typeform-popover-button", n.dataset.testid = "typeform-popover-button", n.style.backgroundColor = e, n.style.color = t, n
                        }(m.buttonColor || d.buttonColor);
                    (m.container || document.body).append(g), _.append(y), g.append(j), g.append(E), j.append(O);
                    var T = function() {
                        p && p.parentNode && (p.classList.add("closing"), setTimeout((function() {
                            r.unmountElement(p)
                        }), 250))
                    };
                    m.tooltip && m.tooltip.length > 0 && (p = function(e, t) {
                        var n = document.createElement("span");
                        n.className = "typeform-popover-tooltip-close", n.dataset.testid = "typeform-popover-tooltip-close", n.innerHTML = "&times;", n.onclick = t;
                        var o = document.createElement("div");
                        o.className = "typeform-popover-tooltip-text", o.innerHTML = e;
                        var r = document.createElement("div");
                        return r.className = "typeform-popover-tooltip", r.dataset.testid = "typeform-popover-tooltip", r.appendChild(o), r.appendChild(n), r
                    }(m.tooltip, T), g.append(p)), m.notificationDays && (m.enableSandbox || i.canBuildNotificationDot(e)) && (v = i.buildNotificationDot(), j.append(v)), y.onload = function() {
                        g.classList.add("open"), _.style.opacity = "1", E.style.opacity = "1", u(w, P), r.addCustomKeyboardListener(I)
                    };
                    var C = function() {
                            a(_) || (T(), v && (v.classList.add("closing"), m.notificationDays && !m.enableSandbox && i.saveNotificationDotHideUntilTime(e, m.notificationDays), setTimeout((function() {
                                r.unmountElement(v)
                            }), 250)), setTimeout((function() {
                                g.append(_), _.style.opacity = "0", E.style.opacity = "0", u(O, w)
                            })))
                        },
                        I = function() {
                            var e;
                            a(g) && (null === (e = t.onClose) || void 0 === e || e.call(t), setTimeout((function() {
                    ...
                    return j.onclick = S, E.onclick = I, m.open && !a(_) && r.handleCustomOpen(C, m.open, m.openValue), {
                        open: C,
                        close: I,
                        toggle: S,
                        refresh: function() {
            ...
            1320: function(e, t) {
                ...
                t.saveNotificationDotHideUntilTime = function(e, t) {
                    ...
                    return e.className = "typeform-popover-unread-dot", e.dataset.testid = "typeform-popover-unread-dot", e
                }
            },
            6100: function(e, t) {
                Object.defineProperty(t, "__esModule", {
            ...
            9630: function(e, t, n) {
                ...
                t.createPopup = function(e, t) {
                    ...
                    var n = t.width,
                        ...
                        b = function() {
                            var e = document.createElement("div");
                            return e.className = "typeform-popup", e.style.opacity = "0", e
                        }(),
                        y = function() {
                            var e = document.createElement("div");
                        ...
                        h = function(e, t, n) {
                            var o = document.createElement("div");
                            return o.className = "typeform-iframe-wrapper", o.style.opacity = "0", r.isDefined(e) && r.isDefined(t) ? r.setElementSize(o, {
                                width: e,
                                height: t
                    ...
                    p.onload = function() {
                        h.style.opacity = "1", setTimeout((function() {
                            y.style.display = "none"
                        }), 250), r.addCustomKeyboardListener(O)
                    };
                    var _ = function() {
                            a(b) || (g.append(b), document.body.style.overflow = "hidden", setTimeout((function() {
                                b.style.opacity = "1"
                            })))
                        },
                        O = function() {
                            a(b) && (null == s || s(), b.style.opacity = "0", h.style.opacity = "0", document.body.style.overflow = m, setTimeout((function() {
                                w(), y.style.display = "block"
                            }), 250))
                        };
                    h.append(function(e) {
                        var t = document.createElement("a");
                        return t.className = "typeform-close", t.style.fontSize="35px", t.style.color="#def78e", t.innerHTML = "&times;", t.onclick = e, t
                    }(O)), r.setAutoClose(v, l.autoClose, O);
                    var w = function() {
                        r.unmountElement(b)
                    };
                    return l.open && !a(b) && r.handleCustomOpen(_, l.open, l.openValue), {
                        open: _,
                        close: O,
                        toggle: function() {
                            a(b) ? O() : _()
            ...
            382: function(e, t, n) {
                ...
                var r = n(6797),
                    ...
                    u = function(e, t) {
                        void 0 === e && (e = "div"), void 0 === t && (t = "typeform-sidetab-button-icon");
                        var n = document.createElement(e);
                        return n.className = t, n.innerHTML = "&times;", n.dataset.testid = t, n
                    },
                    c = function(e, t) {
                ...
                t.createSidetab = function(e, t) {
                    void 0 === t && (t = {});
                    var n, d, s, l, f, p, v, m = o(o({}, i), t),
                        b = r.createIframe(e, "side-tab", m),
                        y = b.iframe,
                        h = b.embedId,
                        g = (n = m.width, d = m.height, (s = document.createElement("div")).className = "typeform-sidetab", s.dataset.testid = "typeform-sidetab", r.setElementSize(s, {
                            width: n,
                            height: d
                        })),
                        _ = function() {
                            var e = document.createElement("div");
                            return e.className = "typeform-sidetab-wrapper", e.dataset.testid = "typeform-sidetab-wrapper", e
                        }(),
                        O = function() {
                            var e = document.createElement("div");
                            e.className = "typeform-spinner";
                            var t = document.createElement("div");
                            return t.className = "typeform-sidetab-button-icon", t.dataset.testid = "spinner-icon", t.append(e), t
                        }(),
                        w = function(e) {
                            var t = r.getTextColor(e),
                                n = document.createElement("button");
                            return n.className = "typeform-sidetab-button", n.style.backgroundColor = e, n.style.color = t, n
                        }(m.buttonColor || i.buttonColor),
                        P = function(e) {
                            var t = document.createElement("span");
                            return t.className = "typeform-sidetab-button-text", t.innerHTML = e, t
                        }(m.buttonText || i.buttonText),
                        E = (l = m.customIcon, f = m.buttonColor || i.buttonColor, p = r.getTextColor(f), (v = document.createElement("div")).className = "typeform-sidetab-button-icon", v.innerHTML = l ? "<img alt='sidetab trigger icon button' src='" + l + '\' style="max-width: 100%; max-height: 100%" />' : '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">\n  <path d="M21 0H0V9L10.5743 24V16.5H21C22.6567 16.5 24 15.1567 24 13.5V3C24 1.34325 22.6567 0 21 0ZM7.5 9.75C6.672 9.75 6 9.07875 6 8.25C6 7.42125 6.672 6.75 7.5 6.75C8.328 6.75 9 7.42125 9 8.25C9 9.07875 8.328 9.75 7.5 9.75ZM12.75 9.75C11.922 9.75 11.25 9.07875 11.25 8.25C11.25 7.42125 11.922 6.75 12.75 6.75C13.578 6.75 14.25 7.42125 14.25 8.25C14.25 9.07875 13.578 9.75 12.75 9.75ZM18 9.75C17.172 9.75 16.5 9.07875 16.5 8.25C16.5 7.42125 17.172 6.75 18 6.75C18.828 6.75 19.5 7.42125 19.5 8.25C19.5 9.07875 18.828 9.75 18 9.75Z" fill="' + p + '"></path>\n</svg>', v.dataset.testid = "default-icon", v),
                        j = u(),
                        T = u("a", "typeform-sidetab-close");
                    document.body.append(g), _.append(y), g.append(w), g.append(T), w.append(E), w.append(P), setTimeout((function() {
                    ...
                    var C = function() {
                        ...
                        I = function() {
                            var e;
                            a(_) && (null === (e = m.onClose) || void 0 === e || e.call(m), g.classList.remove("open"), setTimeout((function() {
                    ...
                    return w.onclick = S, T.onclick = I, m.open && !a(_) && r.handleCustomOpen(C, m.open, m.openValue), {
                        open: C,
                        close: I,
                        toggle: S,
                        refresh: function() {
            ...
            2603: function(e, t, n) {
                ...
                t.createSlider = function(e, t) {
                    ...
                    var n = t.position,
                        ...
                        b = function(e) {
                            var t = document.createElement("div");
                            return t.className = "typeform-slider " + e, t.style.opacity = "0", t
                        }(u),
                        y = function() {
                            var e = document.createElement("div");
                            return e.className = "typeform-spinner", e
                        ...
                        h = function(e, t) {
                            var n = document.createElement("div");
                            return n.className = "typeform-iframe-wrapper", n.style[e] = "-100%", r.setElementSize(n, {
                                width: t
                            })
                        }(u, d);
                    h.append(p), b.append(y), b.append(h);
                    var g = l.container || document.body;
                    p.onload = function() {
                        h.style[u] = "0", setTimeout((function() {
                            y.style.display = "none"
                        }), 500), r.addCustomKeyboardListener(O)
                    };
                    var _ = function() {
                            a(b) || (g.append(b), document.body.style.overflow = "hidden", setTimeout((function() {
                                b.style.opacity = "1"
                        ...
                        O = function() {
                            a(b) && (null == s || s(), b.style.opacity = "0", h.style[u] = "-100%", document.body.style.overflow = m, setTimeout((function() {
                                b.parentNode.removeChild(b), y.style.display = "block"
                            }), 500))
                        };
                    return r.setAutoClose(v, l.autoClose, O), h.append(function(e) {
                        var t = document.createElement("a");
                        return t.className = "typeform-close", t.innerHTML = "&times;", t.onclick = e, t
                    }(O)), l.open && !a(b) && r.handleCustomOpen(_, l.open, l.openValue), {
                        open: _,
                        close: O,
                        toggle: function() {
                            a(b) ? O() : _()
            ...
            718: function(e, t, n) {
                ...
                t.createWidget = function(e, t) {
                    ...
                    var a, u = o.createIframe(e, "widget", n),
                        c = u.embedId,
                        d = u.iframe,
                        s = i.buildWidget(d, t.width, t.height);
                    if (t.container.innerHTML = "", t.container.append(s), n.enableFullscreen) {
                        var l = t.container;
                        window.addEventListener("message", r.getWelcomeScreenHiddenHandler(c, l));
                        var f = ((a = document.createElement("a")).className = "typeform-widget-close", a.innerHTML = "&times;", a);
                        f.onclick = function() {
                            var e;
                            null === (e = t.onClose) || void 0 === e || e.call(t), l.classList.remove("typeform-widget-fullscreen"), t.container.innerHTML = "", t.container.append(s), l.append(f)
                        }, l.append(f)
                    }
                    return {
                        refresh: function() {
                            var e;
                            return null === (e = d.contentWindow) || void 0 === e ? void 0 : e.location.reload()
                        },
                        unmount: function() {
            ...
            1419: function(e, t, n) {
                ...
                t.buildWidget = function(e, t, n) {
                    var r = document.createElement("div");
                    return r.className = "typeform-widget", r.append(e), o.setElementSize(r, {
                        width: t,
                        height: n
                    })
                }
            ...
            3626: function(e, t, n) {
                ...
                t.buildIframeSrc = function(e) {
                    ...
                    if (Object.entries(l).filter((function(e) {
                        ...
                        Object.entries(s.hidden).filter((function(e) {
                            var t = e[1];
                            return a.isDefined(t)
                        })).forEach((function(e) {
                            var t = e[0],
            ...
            1553: function(e, t, n) {
                ...
                t.createIframe = function(e, t, n) {
                    ...
                    return y.src = b, y.dataset.testid = "iframe", y.style.border = "0px", Object.keys(l).forEach((function(e) {
                        y.setAttribute(e, l[e])
                    })), y.addEventListener("load", u.triggerIframeRedraw, {
                        once: !0
                    }), window.addEventListener("message", a.getFormReadyHandler(d, f)), window.addEventListener("message", a.getFormQuestionChangedHandler(d, p)), window.addEventListener("message", a.getFormSubmitHandler(d, v)), "widget" !== t && window.addEventListener("message", c.dispatchCustomKeyEventFromIframe), m && window.addEventListener("message", a.getFormReadyHandler(d, (function() {
            ...
            6797: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), r(n(3626), t), r(n(339), t), r(n(8252), t), r(n(9071), t), r(n(2346), t), r(n(7377), t), r(n(6563), t), r(n(4527), t), r(n(9533), t), r(n(1451), t), r(n(8972), t), r(n(4748), t), r(n(4392), t), r(n(8939), t)
            },
            2346: function(e, t) {
                Object.defineProperty(t, "__esModule", {
                    value: !0
